...
import vn.unicloud.fnb.application.controller.OrderController;
...
public class OrderControllerImpl implements OrderController {
    ...
    @Override
    public ResponseEntity<Object> get(Optional<Long> id, Pageable pageable) throws ExecutionException, InterruptedException {
        OrderQuery query = new OrderQuery(id, pageable);
        var rs = queryGateway.query(query, OrderDto.class).get();
